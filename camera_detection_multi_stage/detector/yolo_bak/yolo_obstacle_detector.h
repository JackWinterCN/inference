...
#include "proto/model_param.pb.h"

#include "camera_detection_multi_stage/detector/yolo/postprocess.h"
...
class ObjectFactoryYoloObstacleDetector
    : public apollo::perception::lib::ObjectFactory {
 public:
  ObjectFactoryYoloObstacleDetector() = default;
  ~ObjectFactoryYoloObstacleDetector() {}
  ::apollo::perception::lib::Any NewInstance() {
    std::cout << "ObjectFactoryYoloObstacleDetector::NewInstance()" << std::endl;
    return ::apollo::perception::lib::Any(new YoloObstacleDetector());
  }
};
// class RegisterFactoryYoloObstacleDetector() {
...
class RegisterFactoryYoloObstacleDetector1 {
 public:
  RegisterFactoryYoloObstacleDetector1() {
    ::apollo::perception::lib::FactoryMap &map =
        ::apollo::perception::lib::GlobalFactoryMap()["BaseObstacleDetector"];
