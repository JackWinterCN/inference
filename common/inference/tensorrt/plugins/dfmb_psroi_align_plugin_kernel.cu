...
__global__ void DFMBPSROIAlignForward_kernel(
...
//     const int group_width, const int part_height, const int part_width,
//     const int num_classes, const int channels_each_class, Dtype *top_data) {
//        DFMBPSROIAlignForward_kernel<<<block_size, thread_size, shared_memory_size, stream>>>(
//       nthreads, bottom_data, heat_map_a, heat_map_b, pad_ratio,
//       batch_size, channels, height, width, pooled_height, pooled_width,
//       bottom_rois, bottom_trans, no_trans, trans_std, sample_per_part,
//       output_channel, group_height, group_width, part_height, part_width,
